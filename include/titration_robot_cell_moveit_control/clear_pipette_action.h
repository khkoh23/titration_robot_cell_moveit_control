#ifndef CLEAR_PIPETTE_ACTION_H
#define CLEAR_PIPETTE_ACTION_H
...
class ClearPipetteAction : public BT::StatefulActionNode {
public:
    using Pipette = titration_robot_interfaces::srv::Pipette;

    ClearPipetteAction(const std::string& name, const BT::NodeConfiguration& config, rclcpp::Node::SharedPtr node_ptr) 
