...
int main(int argc, char** argv) {
  ...
  target.pose.position.x = 0.229;
  target.pose.position.y = -0.077;
  target.pose.position.z = 0.855;
  target.pose.orientation.w = -0.001;
  target.pose.orientation.x = -0.003;
  target.pose.orientation.y = 0.714;
  target.pose.orientation.z = 0.7;
